...
typedef void (*PanteaoActionCallback)(const char *agent_name, const char *name, const char **args, int args_count, const char *action_id, void *context);

typedef struct {
    int socket_fd;
    PanteaoActionCallback callback;
    void *callback_context;
    PanteaoActionCallback wildcard_callback;
    void *wildcard_context;
    int engine_pid;
} PanteaoClient;
